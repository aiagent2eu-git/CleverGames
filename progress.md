...
- Added Google-auth user architecture, private groups, group chat, group-scoped daily results, and SQL migration `20260518-002_create_social_groups_auth.sql`.
...
- Enable Google OAuth provider in Supabase Auth and configure local/production redirect URLs.
