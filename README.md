...
Supabase email links return to the current web origin. In local development that is `http://localhost:5173`; in production it is `https://clever-games.vercel.app`.
